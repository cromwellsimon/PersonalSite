...
internal class Program2
{
    ...
    /// </summary>
    const string pluralsightProfilePath = "PluralsightProfile.html";
    ...
    /// </summary>
    const string parsedCoursesPath = "ParsedCourses.txt";
    ...
    static void Main2(string[] args)
    {
        ...
        {
            Console.WriteLine($"{appStart} could not be found at the start of any lines in PluralsightProfile.html. Make sure that it is set properly!");
        }
